...
export MAIN_PLATFORMS='declare -A main_platforms=( [uno]="arduino:avr:uno" [due]="arduino:sam:arduino_due_x" [zero]="arduino:samd:zero" [esp8266]="esp8266:esp8266:generic" [leonardo]="arduino:avr:leonardo" )'
...
wget https://raw.githubusercontent.com/thomasvnl/esp8266-dht22-sleeper-node/master/travis/arduino-headless.sh -O $HOME/arduino_ide/arduino-headless.sh
